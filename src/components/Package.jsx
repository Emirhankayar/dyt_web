...
export default function PricingCard() {
  return (
    <div className="container w-full flex flex-col items-center justify-evenly mx-auto mb-40">

      <Card color="gray" variant="gradient" className="w-1/3 max-w-[20rem] p-8">
        <CardHeader
          floated={false}
          shadow={false}
          color="transparent"
