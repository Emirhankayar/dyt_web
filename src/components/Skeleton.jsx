...
export function SkeletonBanner() {
  return (
    <div className="mb-2 lg:-mb-8 animate-pulse">
      <div className='w-1/3 lg:w-1/6 bg-gray-400 h-4 rounded-full mb-6 lg:-mb-6'></div>
      ...
      <div className='w-full flex flex-col lg:flex-row justify-center lg:justify-end items-center mb-6 gap-10 mt-10 lg:mt-0 lg:gap-20'>
      <div className='lg:w-1/3 flex flex-row space-x-10 justify-end items-center'>
        <div className='bg-gray-300 h-10 w-10 rounded-full'></div>
        <div className='bg-gray-300 h-10 w-10 rounded-full'></div>
        <div className='bg-gray-300 h-10 w-10 rounded-full'></div>
      </div>
        <div className='bg-gray-300 h-10 lg:w-1/2 w-full rounded-md'></div>
      </div>
    ...
    <div className='w-full h-full flex flex-row items-center justify-center'>
      <div className="w-full h-80 flex-col items-center justify-center space-y-5 rounded-t-lg animate-pulse mx-auto p-4">
        <div className="h-full max-w-sm mx-auto">
          ...
          <div className="flex-col flex items-start px-4 justify-center rounded-b-lg space-y-4 bg-gray-300">
            ...
            <div className="flex flex-col justify-center items-start w-full space-y-2">
              <div className="w-full h-4 bg-gray-400 rounded-lg"></div>
              <div className="w-4/5 h-4 bg-gray-400 rounded-lg"></div>
